module completions {
  ...
  export extern "atuin stats" [
    ...period: string         # Compute statistics for the specified period, leave blank for statistics since the beginning. See https://docs.atuin.sh/reference/stats/ for more details
